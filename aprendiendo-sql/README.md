...
El operador UNION se utiliza para combinar los resultados de dos o mas cinsultas SELECT en un solo conjunto de resultados. La principal caracteristica de UNION es que se elimina filas duplicadas del resultado final.
